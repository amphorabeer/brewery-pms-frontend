...
interface EditIngredientClientProps {
  id: string;
}

export default function EditIngredientClient({ id }: EditIngredientClientProps) {
  const router = useRouter();
  const { ingredient, isLoading, updateIngredient } = useIngredient(id);
